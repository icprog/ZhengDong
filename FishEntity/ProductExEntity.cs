...
namespace FishEntity
{
    public  class ProductExEntity
    {
		...
		private string _confirmsgsquantity;
        ...
        private string _SalePurchaseCode;
        private string _PlaceOfDelivery;
        private decimal? _SaleNumWeight;
		...
		/// 
		/// </summary>
		public string confirmsgsquantity
		{
        ...
        public string SalePurchaseCode
        {
            get
            {
                return _SalePurchaseCode;
            }

            set
            {
                _SalePurchaseCode = value;
            }
        }
        /// <summary>
        /// 确盘重量
        ...
        /// 销售重量
        /// </summary>
        public decimal? SaleNumWeight
        {
            get
            {
                return _SaleNumWeight;
            }

            set
            {
                _SaleNumWeight = value;
            }
        }
        /// <summary>
        /// 出库时间
