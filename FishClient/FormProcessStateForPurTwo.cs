...
{
    public partial class FormProcessStateForPurTwo :FormMenuBase
    {
        FishBll.Bll.ProcessStateForPurTwoBll _bll=null;
        ProcessControl Authority =null;
        DataTable tableView,fishIdTable,tableErrorHWFK,tableWeiWTFK,tableKouWTFK,TableErrorForSK,TableWeiForSK;
        string strWhere=string.Empty;

        public FormProcessStateForPurTwo ( )
        {
            InitializeComponent ( ); ReadColumnConfig(dataGridView1, "Set_128");

            _bll = new FishBll . Bll . ProcessStateForPurTwoBll ( );
        ...
        public override int Query ( )
        {
            ...
            strWhere = strWhere + "  and codeNumZdi !='' or rabzz='1' ";
        ...
        {
            FormSalesRequisition form = new FormSalesRequisition("","two");
            form.ShowDialog();
        }
        void setValue()
        {
        ...
        private void DealDataGridViewHeader ( )
        {
            ...
            helper . Headers . AddRange ( new UILibrary . TwoDimenDataGridView . TopHeader [ ] { header1 ,header2 ,header4 ,header5 ,header6 } );
        }
        ...
        {
            UIForms.FormSetColumnWidth form = new UIForms.FormSetColumnWidth(dataGridView1.Columns, "Set_128");
            form.ShowDialog();

            ReadColumnConfig(dataGridView1, "Set_128");
        }
        ...
        FormOutboundAssociation OutboundTable = null;
        FormOnepoundTable BillofladingTable = null;
        ...
        //void setValue ( )
        //{
        //    string numbering = string . Empty, errorValue2 = string . Empty;
        //    bool result3 = false, result4 = false, result5 = false, result6 = false, result7 = false;
        ...
        //        dataGridView1 . Rows [ i ] . Cells [ "product_id" ] . Value = tableView . Rows [ i ] [ "product_id" ] . ToString ( );
        //        numbering = tableView . Rows [ i ] [ "Numbering" ] . ToString ( );
        //        dataGridView1 . Rows [ i ] . Cells [ "Numbering" ] . Value = numbering;
        //        dataGridView1 . Rows [ i ] . Cells [ "code" ] . Value = tableView . Rows [ i ] [ "code" ] . ToString ( );
        //        dataGridView1 . Rows [ i ] . Cells [ "demand" ] . Value = tableView . Rows [ i ] [ "demand" ] . ToString ( );
        //        dataGridView1 . Rows [ i ] . Cells [ "Signdate" ] . Value = tableView . Rows [ i ] [ "Signdate" ] . ToString ( );
        ...
        //        else
        //            dataGridView1 . Rows [ i ] . Cells [ "code1" ] . Style . BackColor = Color . FromName ( "LightPink" );
        //        dataGridView1 . Rows [ i ] . Cells [ "code1" ] . Value = string . Empty;
        ...
        //        else
        //            dataGridView1 . Rows [ i ] . Cells [ "code2" ] . Style . BackColor = Color . FromName ( "LightPink" );
        //        dataGridView1 . Rows [ i ] . Cells [ "code2" ] . Value = string . Empty;

        //        values = tableView . Rows [ i ] [ "coun1" ] . ToString ( );
        //        if ( !string . IsNullOrEmpty ( values ) && Convert . ToDecimal ( values ) < 100 )
        //            dataGridView1 . Rows [ i ] . Cells [ "coun1" ] . Style . BackColor = Color . FromName ( "LightBlue" );
        //        else
        //            dataGridView1 . Rows [ i ] . Cells [ "coun1" ] . Style . BackColor = Color . FromName ( "LightPink" );
        //        if ( string . IsNullOrEmpty ( values ) )
        ...
        //        values = tableView . Rows [ i ] [ "coun3" ] . ToString ( );
        //        if ( !string . IsNullOrEmpty ( values ) && Convert . ToDecimal ( values ) < 100 )
        //            dataGridView1 . Rows [ i ] . Cells [ "coun3" ] . Style . BackColor = Color . FromName ( "LightBlue" );
        //        else
        //            dataGridView1 . Rows [ i ] . Cells [ "coun3" ] . Style . BackColor = Color . FromName ( "LightPink" );
        //        if ( string . IsNullOrEmpty ( values ) )
        //        {
        //            dataGridView1 . Rows [ i ] . Cells [ "coun3" ] . Value = "0%";
        //            dataGridView1 . Rows [ i ] . Cells [ "coun3" ] . Style . BackColor = Color . FromName ( "LightBlue" );
        //        }
        //        else
        //            dataGridView1 . Rows [ i ] . Cells [ "coun3" ] . Value = values + "%";
        ...
        //        values = tableView . Rows [ i ] [ "ton2" ] . ToString ( );
        //        if ( !string . IsNullOrEmpty ( values ) && Convert . ToDecimal ( values ) < 100 )
        //            dataGridView1 . Rows [ i ] . Cells [ "ton2" ] . Style . BackColor = Color . FromName ( "LightBlue" );
        //        else
        //            dataGridView1 . Rows [ i ] . Cells [ "ton2" ] . Style . BackColor = Color . FromName ( "LightPink" );
        //        if ( string . IsNullOrEmpty ( values ) )
        //        {
        //            dataGridView1 . Rows [ i ] . Cells [ "ton2" ] . Value = "0%";
        //            dataGridView1 . Rows [ i ] . Cells [ "ton2" ] . Style . BackColor = Color . FromName ( "LightBlue" );
        //        }
        //        else
        //            dataGridView1 . Rows [ i ] . Cells [ "ton2" ] . Value = values + "%";

        //        values = tableView . Rows [ i ] [ "ton1" ] . ToString ( );
        //        if ( !string . IsNullOrEmpty ( values ) && Convert . ToDecimal ( values ) < 100 )
        //            dataGridView1 . Rows [ i ] . Cells [ "ton1" ] . Style . BackColor = Color . FromName ( "LightBlue" );
        //        else
        //            dataGridView1 . Rows [ i ] . Cells [ "ton1" ] . Style . BackColor = Color . FromName ( "LightPink" );
        //        if ( string . IsNullOrEmpty ( values ) )
        //        {
        //            dataGridView1 . Rows [ i ] . Cells [ "ton1" ] . Value = "0%";
        //            dataGridView1 . Rows [ i ] . Cells [ "ton1" ] . Style . BackColor = Color . FromName ( "LightBlue" );
        //        }
        //        else
        //            dataGridView1 . Rows [ i ] . Cells [ "ton1" ] . Value = values + "%";


        //        if ( !string . IsNullOrEmpty ( numbering ) && result3 == true )
        //        {
        //            if ( tableErrorHWFK . Select ( "Numbering='" + numbering + "'" ) . Length > 0 )
        //            {
        //                errorValue2 = tableErrorHWFK . Select ( "Numbering='" + numbering + "'" ) [ 0 ] [ "calcu" ] . ToString ( );
        //                if ( string . IsNullOrEmpty ( errorValue2 ) )
        //                    dataGridView1 . Rows [ i ] . Cells [ "error2" ] . Style . BackColor = Color . FromName ( "LightPink" );
        //                else if ( Convert . ToDecimal ( errorValue2 ) != 0 )
        //                    dataGridView1 . Rows [ i ] . Cells [ "error2" ] . Style . BackColor = Color . FromName ( "Yellow" );
        //                else
        //                    dataGridView1 . Rows [ i ] . Cells [ "error2" ] . Style . BackColor = Color . FromName ( "LightPink" );
        //            }
        //            else
        ...
        //        if ( !string . IsNullOrEmpty ( numbering ) && result4 == true )
        //        {
        //            if ( tableWeiWTFK . Select ( "Numbering='" + numbering + "'" ) . Length > 0 )
        //                dataGridView1 . Rows [ i ] . Cells [ "wei2" ] . Style . BackColor = Color . FromName ( "LightGreen" );
        //            else
        //                dataGridView1 . Rows [ i ] . Cells [ "wei2" ] . Style . BackColor = Color . FromName ( "LightPink" );
        //        }
        //        else
        //            dataGridView1 . Rows [ i ] . Cells [ "wei2" ] . Style . BackColor = Color . FromName ( "LightPink" );

        //        if ( !string . IsNullOrEmpty ( numbering ) && result5 == true )
        //        {
        //            if ( tableKouWTFK . Select ( "Numbering='" + numbering + "'" ) . Length > 0 )
        //                dataGridView1 . Rows [ i ] . Cells [ "wei2" ] . Style . BackColor = Color . FromName ( "Yellow" );
        //            else
        //                dataGridView1 . Rows [ i ] . Cells [ "wei2" ] . Style . BackColor = Color . FromName ( "LightPink" );
        //        }
        //        else
        ...
        //        if ( !string . IsNullOrEmpty ( numbering ) && result6 == true )
        //        {
        //            if ( TableErrorForSK . Select ( "Numbering='" + numbering + "'" ) . Length > 0 )
        //                dataGridView1 . Rows [ i ] . Cells [ "error3" ] . Style . BackColor = Color . FromName ( "Yellow" );
        //            else
        //                dataGridView1 . Rows [ i ] . Cells [ "error3" ] . Style . BackColor = Color . FromName ( "LightPink" );
        //        }
        //        else
        //            dataGridView1 . Rows [ i ] . Cells [ "error3" ] . Style . BackColor = Color . FromName ( "LightPink" );

        //        if ( !string . IsNullOrEmpty ( numbering ) && result7 == true )
        //        {
        //            if ( TableWeiForSK . Select ( "Numbering='" + numbering + "'" ) . Length > 0 )
        //                dataGridView1 . Rows [ i ] . Cells [ "error3" ] . Style . BackColor = Color . FromName ( "LightGreen" );
        //            else
        //                dataGridView1 . Rows [ i ] . Cells [ "error3" ] . Style . BackColor = Color . FromName ( "LightPink" );
        //        }
        //        else
