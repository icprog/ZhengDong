namespace TCUILibrary
{
    ...
    public class SkinTabControl : TabControl
    {
        ...
        private void DrawTabPages(Graphics g)
        {
            ...
            //DrawTabHeader(g);
            //watch.Stop();
            //TCUtility.LogHelper.WriteLog("DrawTabHeader:"+watch.ElapsedMilliseconds + "ms");
            ...
            for (int i = 0; i < base.TabCount; i++)
            {
                ...
                this.Icon = ((page.ImageIndex != -1) && (base.ImageList != null)) ? base.ImageList.Images[page.ImageIndex] : null;
                Image image = null;
                Image image2 = null;
                if (base.SelectedIndex == i)
                {
                    image = _tabDownback; //Resources.tab_dots_down;
                    ...
                    ContextMenuStrip contextMenuStrip = page.ContextMenuStrip;
                    if (contextMenuStrip != null)
                    {
                        ...
                        if (empty.Contains(pt))
                        {
                            ...
                            {
                                image2 = _tabNormlback; //Resources.tab_dots_normal;
                            }
                ...
                txtRect.X = txtRect.X + page.Margin.Left + page.Padding.Left+2;
                txtRect.Width = txtRect.Width - page.Margin.Left - page.Margin.Right - page.Padding.Left-page.Padding.Right;
                if (this.Icon != null)
                {
                    txtRect.X = txtRect.X  + this.Icon.Width;
                    txtRect.Width = txtRect.Width - this .Icon.Width; 
                }
                if( this._closeTabHoverImage !=null)
                {
                ...
                //watch.Stop();
                //TCUtility.LogHelper.WriteLog( "DrawTabCloseImage:" + watch.ElapsedMilliseconds+"ms");
            ...
            //watch2.Stop();
            //TCUtility.LogHelper.WriteLog("wwwww:"+ watch2.ElapsedMilliseconds +"ms");
        }
