...
namespace FishBll.Dao
{
    public class ProductSelfSaleDao
    {
        ...
        public DataSet ziying(string where)
        {
            StringBuilder strSql = new StringBuilder();
            //strSql.Append("select *,sum(qiuhe) qiuhe from v_ziying ");
            strSql.Append("select *,sum(qiuhe) qiuhe from( ");
            strSql.Append("select * from v_xianhuo ");
            strSql.Append("UNION ALL ");
            strSql.Append("select *from v_baopan ");
            strSql.Append("union ALL ");
            strSql.Append("select *from v_thzz ");
            strSql.Append("UNION ALL ");
            strSql.Append("select *from v_cgzy ");
            strSql.Append("union ALL ");
            strSql.Append("select *from v_xszy ");
            strSql.Append(")a  ");
